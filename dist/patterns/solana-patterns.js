...
function getPatternsBySeverity(severity) {
    return exports.SOLANA_PATTERNS.filter((p) => p.severity === severity);
}
function getPatternsByCategory(category) {
    return exports.SOLANA_PATTERNS.filter((p) => p.category.toLowerCase() === category.toLowerCase());
}
//# sourceMappingURL=solana-patterns.js.map